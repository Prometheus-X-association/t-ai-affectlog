...
export const OUTPUT_CATALOG: OutputArtifact[] = [
  ...
  { id: "carisma_metadata_json", label: "CARiSMA Metadata JSON", description: "Audit metadata in CARiSMA format for Prometheus-X interoperability.", format: "json", filenameTemplate: "carisma_metadata.json", requiresAnalyses: ["carisma_metadata_export"], requiresModel: false, privacySensitive: false, blockedWithoutPrivacyAck: false, notes: "" },
  { id: "lola_metadata_json", label: "LOLA Metadata JSON", description: "Dataset metadata in LOLA format.", format: "json", filenameTemplate: "lola_metadata.json", requiresAnalyses: ["lola_metadata_export"], requiresModel: false, privacySensitive: false, blockedWithoutPrivacyAck: false, notes: "" },
