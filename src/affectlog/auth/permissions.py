...
ROLE_DEFAULTS: dict[str, list[str]] = {
    ...
    "Admin": [
        P.USERS_READ, P.USERS_CREATE, P.USERS_UPDATE, P.USERS_DISABLE,
        P.USERS_APPROVE, P.USERS_ASSIGN_ROLES,
    ...
    "Project Maintainer": [
        P.DATASETS_READ, P.DATASETS_UPLOAD, P.DATASETS_TRANSFORM, P.DATASETS_PROFILE, P.DATASETS_DELETE,
        P.PRIVACY_CONFIGURE,
        P.AUDITS_RUN, P.AUDITS_READ, P.AUDITS_DELETE,
        P.REPORTS_READ, P.REPORTS_EXPORT,
        P.RECIPES_READ, P.RECIPES_CREATE, P.RECIPES_UPDATE, P.RECIPES_PUBLISH,
        P.PDC_CONFIGURE,
        P.MODELS_READ, P.MODELS_REGISTER,
        P.COMPLIANCE_READ, P.COMPLIANCE_EXPORT,
    ],
    "Auditor": [
        P.DATASETS_READ,
        P.AUDITS_RUN, P.AUDITS_READ,
        P.REPORTS_READ, P.REPORTS_EXPORT,
        P.COMPLIANCE_READ,
        P.MODELS_READ,
        P.RECIPES_READ,
    ...
    "Data Steward": [
        P.DATASETS_READ, P.DATASETS_UPLOAD, P.DATASETS_TRANSFORM, P.DATASETS_PROFILE,
        P.PRIVACY_CONFIGURE,
        P.AUDITS_RUN, P.AUDITS_READ,
        P.REPORTS_READ,
        P.RECIPES_READ,
    ...
    "Model Developer": [
        P.MODELS_REGISTER, P.MODELS_READ, P.MODELS_PREDICT, P.MODELS_EXPLAIN,
        P.DATASETS_READ,
        P.REPORTS_READ,
        P.COMPLIANCE_READ,
    ],
    ...
    "Developer Contributor": [
        P.RECIPES_READ, P.RECIPES_CREATE,
        P.DATASETS_READ,
        P.REPORTS_READ,
        P.MODELS_READ,
    ],
